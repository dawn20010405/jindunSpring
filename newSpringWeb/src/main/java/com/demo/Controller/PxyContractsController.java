...
public class PxyContractsController {
    ...
    public Integer InsertJust(String ckaitime, String cjietime, Integer cqixian, Integer eid, String cleixing){
    ...
    public PageInfo<Contracts> listselectcontracts(@RequestParam("no") Integer pageNo,
