...
public interface IZzlxiangmuMapper {
     ...
     * @Author lichao
     * @Description //TODO
     * @Date 16:22 2020/12/25
     * @Param
     * @return
            **/

    List<Myproject> listxiangmu3(@Param("empno") Integer empno, @Param("tid") Integer tid, @Param("state") Integer state, @Param("evel") Integer evel);
    /*
     * @Author lichao
     * @Description //TODO
     * @Date 16:22 2020/12/25
     ...
     * @return: java.lang.Integer
     * @auther: zzl
     * @date: 2020-12-25 2:22
     */
    Integer wancheng(Integer xid);
    /*
     * @Author lichao
     * @Description //TODO 
     * @Date 16:21 2020/12/25
     * @Param  
     * @return 
            **/

    Integer addempandxm(@Param("xid") Integer xid,@Param("empno") Integer empno);
